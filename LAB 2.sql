...
SELECT* FROM DEPOSITE WHERE ACTNO=106 
...
SELECT* FROM DEPOSITE WHERE ADATE>'1996-12-01' 
...
SELECT * FROM DEPOSITE WHERE  AMOUNT>4000 AND ACTNO<105
...
SELECT DISTINCT BNAME ,CITY FROM BRANCH 
