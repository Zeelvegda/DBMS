...
SELECT TOP 2 * INTO EMPLOYEE_DATA FROM EMPLOYEE
...
UPDATE DEPOSITE SET AMOUNT=5000,ACTNO=111
WHERE BNAME='SANDIP'
...
UPDATE DEPOSITE SET BNAME='NEHRU PALACE'
WHERE CNAME='MEHUL'
...
UPDATE DEPOSITE SET ADATE='1995-04-01'
WHERE CNAME='ANIL'
...
UPDATE DEPOSITE SET AMOUNT=5000 ,ADATE='1996-04-01'
WHERE CNAME='PRAMOD'
